...
import ModuleCollection from 'old/collections/module';
import ActionCollection from 'old/collections/action';
import IdManager from 'old/components/id-manager';

var ContainerModule = AreaModule.extend({
  // @Override
  defaults: function() {
    return _.defaults({
      children: new ModuleCollection(),
      actions: new ActionCollection()
    }, _.result(AreaModule.prototype, 'defaults'));
  },

  // @Override
  initialize: function() {
    AreaModule.prototype.initialize.apply(this, arguments);

    this._droppableContainers = new ModuleCollection();
